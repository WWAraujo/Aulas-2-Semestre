 ...
 */
public class Seila extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Seila.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
